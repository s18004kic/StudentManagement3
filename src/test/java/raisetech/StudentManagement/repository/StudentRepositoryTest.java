...
class StudentRepositoryTest {
  ...
  void 受講生のコース情報が正しく更新されること() {
    ...
    // Assert: 更新結果を検証
    StudentCourse updatedCourse = sut.updateStudentCourse(studentId);
    assertNotNull(updatedCourse);
    assertEquals("AWSコース", updatedCourse.getCourseName());
    assertEquals(LocalDateTime.of(2023, 5, 1, 10, 0), updatedCourse.getCourseStartAt());
    assertEquals(LocalDateTime.of(2023, 8, 1, 16, 0), updatedCourse.getCourseEndAt());
  }
